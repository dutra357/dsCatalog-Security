...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<UserDto> InsertUser(@RequestBody UserInsertDto newUser) {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<UserDto> updateUser(@PathVariable Long id, @RequestBody UserInsertDto userUpdate) {
